...
void GameMap1::InitBarrier()
{
	...
	BarrierSprite10->position[0] = {4,10 };
	...
	BarrierSprite11->position[0] = { 2,10 };
	BarrierSprite11->position[1] = { 2,11 };
	...
	BarrierSprite12->position[0] = {3,8 };
}
